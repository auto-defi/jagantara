...
import { useDAOGovernance } from "@/hooks/useStacksContracts";
      ...
      try {
        ...
        for (const id of claimIds) {
          try {
            ...
            const minimumVotingPeriod = await getVotingPeriod(); // Get voting period from contract
                              ...
                              <div className="flex justify-between text-xs">
                                <div className="flex flex-col md:flex-row items-center gap-3">
                                  ...
                                  <Button
                                    ...
                                    onClick={() =>
                                      window.open(
                                        `https://explorer.stacks.co/address/${proposal.coveredAddress}`,
                                        "_blank"
                                      )
                                    }
                                  >
