...
const items = [
  ...
  },
  {
    title: "Stacks Spark",
    description:
      "A Web3 launchpad and incubator leveraging Stacks's fast, accessible, and developer-friendly blockchain to empower gaming, metaverse, and NFT projects.",
    header: (
      <Image
        src={"/campaign_logos/stacks_logo.svg"}
        width={600}
        height={250}
